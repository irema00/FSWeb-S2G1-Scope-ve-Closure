...
/*Görev 1: macSkoru()
  ...
  skor 1 closure kulanmaktadır. skor 2 doğrudan değeri return eder.

  2. Hangisi bir closure kullanmaktadır? Nasıl tarif edebilirsin? (yarınki derste öğreneceksin :) )

    skor 1 closure kullanmaktadır. yani iç içe geçmiş function'lar vardır.
  
  3. Hangi durumda skor1 tercih edilebilir? Hangi durumda skor2 daha mantıklıdır?

  Gizlilik, değişkenin erişilebilirliğini kontrol etmek ve veri güvenliğinin önemli olduğu durumlarda skor1 tercih edilebilir. Verinin ulaşılabilirliğinin ve paylaşımının sorun olmadığı durumlarda skor 2 kullanılabilir.
